      ...
      <!--&gt;<span class="subdirectory-url">/{{subdirectorySanitized}}/</span-->
        ...
        <!--<div class="button-wrapper wrapper">-->
            ...
            <!--<b-dropdown hoverable v-show="!isEditing && slug.length > 1">-->
                ...
                <!--</b-dropdown-item>-->
            <!--</b-dropdown>-->
            <!--&lt;!&ndash; <button class="save-slug-button button is-small" v-show="!isEditing && slug.length > 1" @click.prevent="copyUrl"><i class="fa fa-copy"></i><span class="m-l-5">Copy</span></button> &ndash;&gt;-->
            <!--<button class="save-slug-button button is-small" v-show="isEditing" @click.prevent="saveSlug">{{customSlug == slug ? 'Cancel' : 'Save'}}</button>-->
            <!--<button class="save-slug-button button is-small" v-show="isEditing" @click.prevent="resetEditing">Reset</button>-->
        <!--</div>-->
    <!--</div>-->
    <!--&lt;!&ndash;<div class="slug-widget">&ndash;&gt;-->
       <!--&lt;!&ndash;<div class="icon-wrapper wrapper">&ndash;&gt;-->
           <!--&lt;!&ndash;<i class="fa fa-link"></i>&ndash;&gt;-->
       <!--&lt;!&ndash;</div>&ndash;&gt;-->
        <!--&lt;!&ndash;<div class="url-wrapper wrapper">&ndash;&gt;-->
            <!--&lt;!&ndash;<span class="root-url">{{ url }}</span&ndash;&gt;-->
            <!--&lt;!&ndash;&gt;<span class="subdirectory-url">{{ subdirectory}}</span&ndash;&gt;-->
            <!--&lt;!&ndash;&gt;<span class="slug" v-show="slug && !isEditing">{{ slug}}</span&ndash;&gt;-->
            <!--&lt;!&ndash;&gt;<span class="slug-edit" v-show="isEditing"><input type="text" name="slug" class="input" v-model="customSlug"  /></span>&ndash;&gt;-->
        <!--&lt;!&ndash;</div>&ndash;&gt;-->

        <!--&lt;!&ndash;<div class="button-wrapper wrapper">&ndash;&gt;-->
            <!--&lt;!&ndash;<button class="save-slug-button button is-small" v-show="!isEditing" @click.prevent="editSlug">Edit</button>&ndash;&gt;-->
            <!--&lt;!&ndash;<button class="save-slug-button button is-small" v-show="isEditing" @click.prevent="saveSlug">Save</button>&ndash;&gt;-->
            <!--&lt;!&ndash;<button class="save-slug-button button is-small" v-show="isEditing" @click.prevent="resetEditing">Reset</button>&ndash;&gt;-->
        <!--&lt;!&ndash;</div>&ndash;&gt;-->
    <!--&lt;!&ndash;</div>&ndash;&gt;-->
<!--</template>-->
