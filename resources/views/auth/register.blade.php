                ...
                <div class="card-content">
                    ...
                    <form action="{{ route('register') }}" method="POST" role="form">
                        ...
                        <div class="field">
                            ...
                            <p class="control">
                                <input class="input {{ $errors->has('name') ? 'is-danger' :  ''}}" type="text" name="name" id="name" placeholder="Enter Your Name" value="{{ old('name') }}" required>
                            </p>
                            @if($errors->has('name'))
                                <p class="help is-danger">{{ $errors->first('name') }}There was an error </p>
                            @endif
                        ...
                        <div class="columns">
                            ...
                            <div class="column">
                                <div class="field">
                                    ...
                                    @if($errors->has('password'))
                                        <p class="help is-danger">{{ $errors->first('password_confirmation') }}There was an error </p>
                                    @endif
                                </div>
                            </div>
                        </div>
